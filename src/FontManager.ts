...
const customFonts = [
	...
	category: 'serif',
	family: "Escolar",
	files: { "regular": "httts://static.arasaac.org/fonts/escolar1.ttf" },
	id: "escolar",
	kind: "webfonts#webfont",
	lastModified: "2021-02-12",
	scripts: ['latin', 'latinExt'],
	version: "v1",
	stylesheet: `@font-face {font-family: 'Escolar';font-style: normal;font-weight: 400;src: url(https://static.arasaac.org/fonts/escolar1.ttf);`
},
	{variants: ['regular'],
	category: 'serif',
	family: "Escolar4",
	files: { "regular": "httts://static.arasaac.org/fonts/escolar4.ttf" },
	id: "escolar4",
	kind: "webfonts#webfont",
	lastModified: "2021-02-12",
	scripts: ['latin', 'latinExt'],
	version: "v1",
	stylesheet: `@font-face {font-family: 'Escolar4';font-style: normal;font-weight: 400;src: url(https://static.arasaac.org/fonts/escolar4.ttf);`
},
	{variants: ['regular'],
	category: 'serif',
	family: "OpenDyslexic",
	...
	scripts: ['latin', 'latinExt'],
	version: "v1",
	stylesheet: `@font-face {font-family: 'OpenDyslexic';font-style: normal;font-weight: 400;src: url(https://static.arasaac.org/fonts/OpenDyslexic-Regular.otf);`
},
	{variants: ['regular'],
	category: 'serif',
	...
	scripts: ['latin', 'latinExt'],
	version: "v1",
	stylesheet: `@font-face {font-family: 'Atkinson-Hyperlegible';font-style: normal;font-weight: 400;src: url(https://static.arasaac.org/fonts/Atkinson-Hyperlegible-Regular-102.woff);`
},
	{variants: ['regular'],
	category: 'serif',
	family: "Memima",
	...
	scripts: ['latin', 'latinExt'],
	version: "v1",
	stylesheet: `@font-face {font-family: 'Memima';font-style: normal;font-weight: 400;src: url(https://static.arasaac.org/fonts/Memima.ttf);`
},
	{variants: ['regular'],
	category: 'serif',
	family: "Massallera",
	...
	scripts: ['latin', 'latinExt'],
	version: "v1",
	stylesheet: `@font-face {font-family: 'Massallera';font-style: normal;font-weight: 400;src: url(https://static.arasaac.org/fonts/massallera.ttf);`
},
	{variants: ['regular'],
	category: 'serif',
	family: "Pipomayu",
	...
	scripts: ['latin', 'latinExt'],
	version: "v1",
	stylesheet: `@font-face {font-family: 'Pipomayu';font-style: normal;font-weight: 400;src: url(https://static.arasaac.org/fonts/pipomayu.ttf);`
},
] as Font[]
...
export default class FontManager {
	...
	public async init(): Promise<FontList> {
		...
		const googleFonts = await getFontList(this.apiKey);

		const fonts =  [...customFonts, ...googleFonts]
